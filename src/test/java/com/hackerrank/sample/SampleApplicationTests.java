...
//		mockMvc.perform(get("/defaultHello")).andDo(print()).andExpect(jsonPath("$.echo").value("Default Hello World!"))
...
//				.andExpect(jsonPath("$.echo").value("Default Hello World!")).andExpect(status().isOk());
//	}
//
//	@Test
...
//				.andExpect(jsonPath("$.echo").value("Custom Custom Hello World!")).andExpect(status().isOk());
//	}
//
//	@Test
//	public void customHelloWithEmptyParamTest() throws Exception {
//		mockMvc.perform(post("/customHello").param("message", "")).andDo(print())
//				.andExpect(jsonPath("$.echo").value("Custom ")).andExpect(status().isOk());
//	}
//
//	@Test
